...
public class MemberVO implements Serializable{
	...
	@JsonIgnore				//@JsonIgnore 마샬링 제외
	@ToString.Exclude
	@Size(min = 6, max = 6)
	private transient String memRegno1;		//transient 직렬화 제외
	@JsonIgnore
	@ToString.Exclude
	private transient String memRegno2;
	@DateTimeFormat(iso = ISO.DATE_TIME)
//	@JsonFormat(shape = Shape.STRING)			//json데이터 만들 때 동작함
...
//	@JsonFormat(shape = Shape.STRING)
	...
	private MultipartFile memImage; // 클라이언트 업로드 파일 수신
