<%@page import="kr.or.ddit.dao.MemberVO"%>
...
<table class="table table-bordered">
	<tr>
		<th>프로필</th>
		<td>
			<img src="data:image/*;bas64,${member.base64Img }">
		</td>
	</tr>
	<tr>
		<th>회원아이디</th>
	...
	<tr>
		<td colspan="2">
			...
			<a class="btn btn-primary" href='<c:url value="/member/memberUpdate.do"/>'>개인 정보 수정</a>
		</td>
	</tr>
</table>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="${viewUrl}">${cart.prod.prodName }</a></td>
