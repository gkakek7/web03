...
<table>
	...
	<tr>
		...
		<td><img src='<c:url value="${prodPath}${prod.prodImg}"/>'></td>
	</tr>
	<tr>
		<th>총재고</th>
	...
	<tr>
		<td colspan="2"><a class="btn btn-primary"
			data-go-link="/prod/prodList.do">상품목록</a> <a class="btn btn-primary"
			href="javascript:;" onclick="history.back();">뒤로가기</a> <c:url
				value="/prod/prodUpdate.do" var="updateUrl">
